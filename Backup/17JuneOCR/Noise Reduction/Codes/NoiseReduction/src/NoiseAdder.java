...
public class NoiseAdder{
    ...
    public static void main(String args[])throws IOException{
        ...
        try{
            f = new File("C:\\Users\\User\\Desktop\\gp.jpg");      
            img = ImageIO.read(f);
        }catch(IOException e){
        ...
        for(int y = 0; y < height; y++){
            for(int x = 0; x < width; x++){
                ...
                if(avg > 255/2)
                {
                    ...
                    if(n <= 1) avg = 0;
                    else avg = Math.min(255, avg + rand.nextInt(100));
                }
                else avg = Math.max(0, avg - rand.nextInt(100)); 
        ...
        try{
            f = new File("C:\\Users\\User\\Desktop\\NoisyBlackAndWhite.jpg");
